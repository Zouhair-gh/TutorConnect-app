                                ...
                                <div className="container p-4">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        {formData.role === 'STAFF' && (
                                            <>
                                                <div className="mb-3">
                                                    <label htmlFor="bibliographie"
                                                           className="form-label">Bibliography</label>
                                                    <textarea
                                                        className="form-control"
                                                        id="bibliographie"
                                                        name="bibliographie"
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6 mb-3">
                                                        <label htmlFor="specialiter"
                                                               className="form-label">Speciality</label>
                                                        <input
                                                            type="text"
                                                            className="form-control"
                                                            id="specialiter"
                                                    ...
                                                    <div className="col-md-6 mb-3">
                                                        <label htmlFor="nbrAnneeExp" className="form-label">Years of
                                                            Experience</label>
                                                        <input
                                                            type="number"
                                                            className="form-control"
