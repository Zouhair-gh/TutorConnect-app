                        ...
                        <div className="container p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p className="text-muted">View and submit your deliverables</p>
                                </div>
                            </div>
                                                            ...
                                                            {deliverable.deadline && (
                                                                <div className="mb-3">
                                                                    ...
                                                                    <ProgressBar
                                                                        ...
                                                                        variant={daysRemaining > 7 ? "success" :
                                                                            daysRemaining > 3 ? "warning" : "danger"}
                                    ...
                                    <div className="col-12">
                                        <div className="card border-0 shadow-sm">
                                            <div className="card-body text-center py-5">
                                                ...
                                                <p className="text-muted mb-4">You don't have any active assignments yet</p>
                                            </div>
                                        </div>
                                    </div>
                                )}
