                                                ...
                                                <div className="col-md-6">
                                                    <div className="d-flex align-items-center mb-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="mb-0 fw-bold">{deliverable.participantName}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    ...
                                                    {deliverable.filePath && (
                                                        <div className="mb-3">
                                                            <Button
                                                                ...
                                                                onClick={() => handleDownload(deliverable.filePath)}
                                                            >
                                        ...
                                        <div className="card-body">
                                            ...
                                            <ListGroup variant="flush">
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <span>Status</span>
                                                    <Badge bg={deliverable.status === 'GRADED' ? 'success' :
                                                        deliverable.status === 'SUBMITTED' ? 'info' :
                                                            deliverable.status === 'LATE' ? 'danger' : 'secondary'}>
                                                        {deliverable.status}
                                                    </Badge>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <span>Max Points</span>
                                                    <span className="fw-bold">{deliverable.maxPoints}</span>
                                                </ListGroup.Item>
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                ...
                                                <ListGroup.Item className="d-flex justify-content-between align-items-center">
                                                    <span>Room</span>
                                                    <Link to={`/tutor/rooms/${deliverable.roomId}`} className="text-primary">
