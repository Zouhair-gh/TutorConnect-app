...
//         // Fetch statistics
//         const participantsResponse = await axiosClient.get(
//           `/rooms/${id}/participants`
//         );
//         const deliverablesResponse = await axiosClient.get(
//           `/deliverables/room/${id}`
//         );
//         const sessionsResponse = await axiosClient.get(`/sessions/room/${id}`);

//         setStats({
//           participants: participantsResponse.data.length,
//           assignments: deliverablesResponse.data.length,
...
//                     ID: {room.id} | Active since: {formatDate(room.startDate)}
//                   </p>
//                 </div>
//                 <div className="text-end">
//                   <div className="badge bg-success-light text-success mb-2">
...
//                     Ends on: {formatDate(room.endDate)}
//                   </p>
//                 </div>
//               </div>
