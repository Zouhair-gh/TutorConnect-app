              ...
              <div className="container p-4">
                <div className="card border-danger shadow-sm">
                  <div className="card-body text-center">
                    ...
                    <p className="text-muted">There was a problem fetching the room details.</p>
                          ...
                          <div className="col-md-6 mb-4">
                            <div className="d-flex align-items-center mb-3">
                              ...
                              <div>
                                ...
                                <h5 className="mb-0">{formatDate(room.startDate)}</h5>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="col-md-6 mb-4">
                            <div className="d-flex align-items-center mb-3">
                              ...
                              <div>
                                ...
                                <h5 className="mb-0">{formatDate(room.endDate)}</h5>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <div className="alert alert-info mb-0">
                          <small>
                            ...
                            Cancellation policy applies 48 hours before check-in.
                          </small>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="card shadow-sm">
                      <div className="card-body">
                        ...
                        <div className="d-grid gap-2">
                          <Link to={`/reservations/new?roomId=${id}`} className="btn btn-outline-primary">
                            Make New Reservation
                          </Link>
                          <Link to={`/rooms/edit/${id}`} className="btn btn-outline-secondary">
                            Update Room Details
                          </Link>
                        </div>
                      </div>
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <div className="text-center mb-4">
                      ...
                      <h4>Are you sure?</h4>
                      <p className="text-muted">
                        You are about to delete the room "{room.name}". This action cannot be undone.
                      </p>
                    </div>
                  </div>
