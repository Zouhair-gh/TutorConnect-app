...
import { FiBook, FiClock, FiUsers, FiDollarSign, FiEye, FiSettings, FiRefreshCw } from "react-icons/fi";
                        ...
                        <div className="container p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p className="text-muted">Manage your active tutoring sessions</p>
                                </div>
                                <Link to="/tutor/rooms/request" className="btn btn-primary rounded-pill px-4">
                            ...
                            <div className="row">
                                {rooms.length > 0 ? (
                                    rooms.map((room) => {
                                        ...
                                        const progressPercentage = Math.min(100, Math.max(0, (daysRemaining / 30) * 100));
                                                ...
                                                <div className="card h-100 border-0 shadow-sm">
                                                    <div className="card-header bg-white border-0 pb-0">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <h5 className="mb-0 fw-bold text-truncate">{room.name}</h5>
                                                            <span className={`badge bg-${getProgressVariant(daysRemaining)}-light text-${getProgressVariant(daysRemaining)}`}>
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="d-flex flex-column gap-2 mb-3">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <span>Capacity: <strong>{room.capacity} students</strong></span>
                                                            </div>
                                                            <div className="d-flex align-items-center">
                                                                <FiDollarSign className="me-2 text-success" />
                                                                <span>Amount: <strong>${room.amount}</strong></span>
                                                            </div>
                                                            <div className="d-flex align-items-center">
                                                                <FiClock className="me-2 text-info" />
                                                                <span>Period: <strong>{formatDate(room.startDate)} - {formatDate(room.endDate)}</strong></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="col-12">
                                        <div className="card border-0 shadow-sm">
                                            <div className="card-body text-center py-5">
                                                ...
                                                <p className="text-muted mb-4">You don't have any active classrooms yet</p>
                                                <Link to="/tutor/rooms/request" className="btn btn-primary rounded-pill px-4">
