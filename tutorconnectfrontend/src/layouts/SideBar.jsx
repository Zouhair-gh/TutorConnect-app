                                ...
                                <ul id="iq-sidebar-toggle" className="iq-menu">
                                    ...
                                    <li className=" ">
                                        <a href="#product" className="collapsed" data-toggle="collapse" aria-expanded="false">
                                            <svg className="svg-icon" id="p-dash2" width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><circle cx={9} cy={21} r={1} /><circle cx={20} cy={21} r={1} />
                                        ...
                                        <ul id="product" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-product.html">
                                                    <i className="las la-minus" /><span>List Product</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-product.html">
                                                    <i className="las la-minus" /><span>Add Product</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className=" ">
                                        <a href="#category" className="collapsed" data-toggle="collapse" aria-expanded="false">
                                            <svg className="svg-icon" id="p-dash3" width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><rect x={9} y={9} width={13} height={13} rx={2} ry={2} />
                                        ...
                                        <ul id="category" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-category.html">
                                                    <i className="las la-minus" /><span>List Category</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-category.html">
                                                    <i className="las la-minus" /><span>Add Category</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul id="sale" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-sale.html">
                                                    <i className="las la-minus" /><span>List Sale</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-sale.html">
                                                    <i className="las la-minus" /><span>Add Sale</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className=" ">
                                        <a href="#purchase" className="collapsed" data-toggle="collapse" aria-expanded="false">
                                            <svg className="svg-icon" id="p-dash5" width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><rect x={1} y={4} width={22} height={16} rx={2} ry={2} />
                                        ...
                                        <ul id="purchase" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-purchase.html">
                                                    <i className="las la-minus" /><span>List Purchases</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-purchase.html">
                                                    <i className="las la-minus" /><span>Add purchase</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul id="return" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-returns.html">
                                                    <i className="las la-minus" /><span>List Returns</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-return.html">
                                                    <i className="las la-minus" /><span>Add Return</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul id="people" className="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                            <li className>
                                                <a href="../backend/page-list-customers.html">
                                                    <i className="las la-minus" /><span>Customers</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-customers.html">
                                                    <i className="las la-minus" /><span>Add Customers</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-list-users.html">
                                                    <i className="las la-minus" /><span>Users</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-users.html">
                                                    <i className="las la-minus" /><span>Add Users</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-list-suppliers.html">
                                                    <i className="las la-minus" /><span>Suppliers</span>
                                                </a>
                                            </li>
                                            <li className>
                                                <a href="../backend/page-add-supplier.html">
                                                    <i className="las la-minus" /><span>Add Suppliers</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <div className="card border-none">
                                    <div className="card-body p-0">
                                        <div className="sidebarbottom-content">
                                            <div className="image"><img src="../assets/images/layouts/side-bkg.png" className="img-fluid" alt="side-bkg" /></div>
